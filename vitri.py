...
def idelay(o):
    while(o>0):
        o=o-1
        print(f"[FRIVE][.....""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
        print(f"[FRIVE][X....""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
        print(f"[FRIVE][XX...""]""["+str(o)+"]" "     ",end='\r')
        sleep(1/6)
        print(f"[FRIVE][XXX..""]""["+str(o)+"]"" ",end='\r')
        sleep(1/6)
        print(f"[FRIVE][XXXX.""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
        print(f"[FRIVE][XXXXX""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
